...
@Component({
  selector: 'app-healthy1',
  templateUrl: './healthy1.page.html',
  styleUrls: ['./healthy1.page.scss'],
})
export class Healthy1Page implements OnInit {
...
async presentToast() {
  ...
  ngOnInit() {
    this.db.collection<any>( "food", ref => ref.where ('status' , '==' ,"healthy1").limit(1)).valueChanges ().subscribe((data)=>{
        this.data = data;
